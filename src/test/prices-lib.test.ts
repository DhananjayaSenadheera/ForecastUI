...
describe('prices lib — market comparison', () => {
  const markets: Market[] = [
    { id: 'm1', name: 'Dambulla', shortCode: 'DEC', district: 'Matale', marketType: 1, isEconomicCenter: true, hasStoredData: true, lastStoredDate: '2026-07-10', isTrainingSource: true },
    { id: 'm2', name: 'Colombo', shortCode: 'PET', district: 'Colombo', marketType: 1, isEconomicCenter: false, hasStoredData: true, lastStoredDate: '2026-07-10', isTrainingSource: true },
    { id: 'm3', name: 'Kandy', shortCode: 'KAN', district: 'Kandy', marketType: 1, isEconomicCenter: false, hasStoredData: false, lastStoredDate: null, isTrainingSource: false },
  ];
